...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Ubah border & teks utama menjadi Hijau Emerald (#097969) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #097969}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#097969;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#097969;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#097969;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone mint muda (#f2f9f7) */
    '.info-box{background:#f2f9f7;border:1px solid #d1e9e3;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna dasar Hijau Emerald (#097969) */
    '.paket-box{background:#097969;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan disesuaikan agar nyambung dengan tema emerald */
    '.syarat-box{background:#fcfefd;border:1px solid #d8ece6;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa emerald cerah (#eaf7f4) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#eaf7f4;border:1px solid #bfe3da;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#097969;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #d1e9e3;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
